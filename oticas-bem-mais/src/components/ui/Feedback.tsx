...
export default function Feedback(){
  ...
  <div className="p-10 md:p-20">
    <div className="flex flex-col justify-normal">
      ...
      <h1 className="text-bgPrimary font-bold text-center md:text-left text-2xl mb-10">Pronto para ter a mesma experiência incrível?</h1>
      <Button text="Encontre seu óculos ideal" className="bg-blackColor   text-xl  md:text-xs" />
    </div>
  </div>             
</div>
